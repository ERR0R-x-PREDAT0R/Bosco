...
nocache('../message/help.js', module => console.log(color('[WATCH]', 'cyan'), color(`'${module}'`, 'green'), 'File is updated!'))
	...
	console.log(color(figlet.textSync('PREDATOR BOT BY ALINSHAN', {
		font: 'Standard',
	...
	bosco.browserDescription = ["[PREDATOR]", "firefox", "3.0.0"];
...
`
   ...
   remoteJid: "0@s.whatsapp.net"},message: {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "Alphabot", "caption": `🌹 PREDATOR 🌹`, 'jpegThumbnail': fs.readFileSync(`ds.jpg`)}}}
